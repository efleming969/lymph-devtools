...
declare namespace hyperappFx {
    export type EffectTuple = [ string, any ]

    export function withFx ( app: any ): any

    export function http ( url: string, action: string, options?: any ): EffectTuple
